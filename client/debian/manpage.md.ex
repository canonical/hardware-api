...
hwlib - program to do something

# SYNOPSIS

**hwlib** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**hwlib** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **hwlib** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**hwlib** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    hwlib. See **foo.conf**(5) for further details.
...
**hwlib** provides some return codes, that can be used in scripts:
...
nadzeya <nadzeya@nhpc>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 nadzeya
